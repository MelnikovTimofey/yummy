...
- Brand decisions applied locally: brass CTA/segment/rating repainted to the single accent (PRD §12; oxblood #B04A3E → bordeaux #8E2F3C on 2026-09-24, quiet active segment); original «Дым» logo authored (no logo upstream); Literata + Mulish canonised as guest families (Gelasio dropped — no Cyrillic).
